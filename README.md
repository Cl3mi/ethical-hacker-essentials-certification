...
```
cd existing_repo
git remote add origin https://gitlab.com/cl3mi1/ethical-hacker-essentials-certification.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cl3mi1/ethical-hacker-essentials-certification/-/settings/integrations)
